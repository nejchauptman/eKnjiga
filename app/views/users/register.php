    ...
    <div class="row">
        <div class="col-lg-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                <h5 class="text-center"> Ustvari svoj račun</h5>
                <form action="<?php echo URLROOT; ?>/users/register" method="POST">
                    ...
                    <div class="form-group">
                        <label for="confirm_password"> Potrdi geslo: <sup>*</sup></label>
                        <!-- preverimo, če ni prazen input in ima ustrezni zapis, če nima izpišemo err message, sicer okej -->
                        <input type="password" name="confirm_password" class="form-control form-control-lg <?php echo (!empty($data['confirm_password'])) ?  'is-invalid' : '';?>" value="<?php echo $data['confirm_password'] ;?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="<?php echo URLROOT;?>/users/login" class="btn btn-light btn-block">Že imaš račun?</a>
                        </div> 
                    </div>
                </form>
            </div>
